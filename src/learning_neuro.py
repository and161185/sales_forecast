...
def create_model_is_sell(categorical_columns, embeddings):
    ...
    #dropout1 = layers.Dropout(0.3)(dense1)  # Dropout после первого полносвязного слоя

    dense2 = layers.Dense(128, activation='relu')(dense1)
    #dropout2 = layers.Dropout(0.3)(dense2)  # Dropout после второго полносвязного слоя
